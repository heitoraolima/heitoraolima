...
🖥️ In my daily work (basically, data science), I enjoy using Python via Jupyter Notebook, but I also use Stata and R. I also have some experience with programming, web scraping, Linux, and Oracle databases.
